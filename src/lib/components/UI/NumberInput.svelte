...
<ButtonGroup>
	...
	<Input
		...
		class="w-15 [appearance:textfield] text-center !ring-0 focus:!border-purple-600 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
	/>
	<Button
		type="button"
		onclick={() => {
